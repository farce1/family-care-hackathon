...
def upgrade() -> None:
    ...
    op.create_foreign_key('fk_parsed_appointments_user_id', 'parsed_appointments', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    op.create_index('idx_parsed_appointments_user', 'parsed_appointments', ['user_id'], unique=False)
