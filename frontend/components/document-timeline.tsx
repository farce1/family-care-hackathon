...
export function DocumentTimeline({ documents, accentColor = "orange" }: DocumentTimelineProps) {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={cn(
          "absolute left-[27px] top-0 bottom-0 w-0.5 -z-0",
          accentColor === "orange"
          ...
          <div key={group.monthYear} className="relative">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3
                  className={cn(
                    "text-2xl font-bold font-[family-name:var(--font-quicksand)]",
            ...
            <div className="ml-[84px] space-y-4">
              {group.documents.map((doc) => {
                ...
                return (
                  <Card
                    key={doc.id}
                    className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-border bg-white/80 backdrop-blur-sm overflow-hidden"
                  >
                    <CardContent className="p-5">
                      <div className="flex items-start gap-4">
                        {/* Document Icon */}
                        <div className={cn("p-3 rounded-lg shrink-0", colors.bg)}>
