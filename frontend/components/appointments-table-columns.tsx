...
export const appointmentsTableColumns: ColumnDef<Appointment>[] = [
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col">
          <span className="font-semibold text-foreground">{format(date, "MMM d, yyyy")}</span>
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="font-semibold text-foreground">{appointment.familyMemberName}</div>
            {memberInfo?.role && (
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex flex-col max-w-xs">
          <span className="font-semibold text-foreground truncate">{appointment.facilityName}</span>
          {appointment.doctorName && (
            <span className="text-sm text-muted-foreground truncate">{appointment.doctorName}</span>
          )}
        </div>
      );
    },
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <div className="font-medium text-foreground">{type}</div>;
    },
  },
  {
    accessorKey: "status",
